...
- Rendering split into pure `resting_order_line` / `distance_to_market`; 15 assertions on the live 08-04 fixture, including the missing-mid and the `$60000` case that `:.5f` would have printed as `$60000.00000`
